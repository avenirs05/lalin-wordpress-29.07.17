...
<div class="category-content-wrap">
    <div class="category-wrap">
        ...
        <ul id="laser-cosmetology" style="display: none;">
            ...
            <li id="acne-treatment"><a href="services-laser_cosmetology-acne_treatment" class="category-item">Лечение акне, постакне, розацеа, демодекоза</a></li>
            <li id="remove-pigment-spots"><a href="services-laser_cosmetology-remove_pigment_spots" class="category-item">Удаление пигментных пятен</a></li>
            <li id="removing-stretch"><a href="services-laser_cosmetology-removing_stretch" class="category-item">Удаление рубцов и растяжек</a></li>
            <li id="remove-vessels-on-face"><a href="services-laser_cosmetology-remove_vessels_on_face" class="category-item">Удаление сосудов на лице и теле</a></li>
            <li id="photo-rejuve"><a href="services-laser_cosmetology-photo_rejuve" class="category-item">Фотоомоложение</a></li>
        </ul>
    </div>
    ...
    <div class="category-wrap">
        ...
        <ul id="figure-correction" style="display: none;">        
            ...
            <li id="liposuction"><a href="services-figure_correction-liposuction" class="category-item">УЗ-липосакция с RF-лифтингом</a></li>
            <li id="massage"><a href="services-figure_correction-massage" class="category-item">Массаж</a></li>
            <li id="acupuncture"><a href="services-figure_correction-acupuncture" class="category-item">Иглорефлексотерапия</a></li>
        </ul>
    </div>
    ...
    <div class="category-wrap">
        ...
        <ul id="injection-cosmetology" style="display: none;">        
            ...
            <li id="change-lips"><a href="services-injection_cosmetology-change_lips" class="category-item">Изменение формы и объема губ</a></li>
            <li id="contour-plastic"><a href="services-injection_cosmetology-contour_plastic" class="category-item">Контурная пластика</a></li>
            <li id="mesotherapy"><a href="services-injection_cosmetology-mesotherapy" class="category-item">Мезотерапия</a></li>
            <li id="plazmolifting"><a href="services-injection_cosmetology-plazmolifting" class="category-item">Плазмолифтинг</a></li>
        </ul>
    </div>
    ...
    <div class="category-wrap">
        ...
        <ul id="esthetic-cosmetology" style="display: none;">        
            ...
            <li id="plazmolifting-gynecology"><a href="services-esthetic_cosmetology-plazmolifting_gynecology" class="category-item">Плазмолифтинг в гинекологии и интимной косметологии</a></li>
            <li id="kontur-intim"><a href="services-esthetic_cosmetology-kontur_intim" class="category-item">Контурная интимная пластика</a></li>
        </ul>
    </div>
</div>